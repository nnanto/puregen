...
func generateJavaEnum(gen *protogen.Plugin, file *protogen.File, enum *protogen.Enum, javaPackage, packageDir string) {
...
func generateJavaClient(gen *protogen.Plugin, file *protogen.File, service *protogen.Service, javaPackage, packageDir string, commonNamespace string) {
	serviceName := service.GoName
